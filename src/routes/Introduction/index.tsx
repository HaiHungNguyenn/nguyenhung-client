    ...
    return (
        <main className='mt-40 w-full h-fit flex flex-col '>
            <div className='w-full h-fit relative '>
                <img className="w-full h-[200vh]" src={WallPaper} alt="" />
                <div className='absolute top-0 w-full h-fit  flex flex-col items-center justify-start'>
                    <h1 className='text-[40px] text-accent w-fit font-bold py-16 px-48 text-center border-t-2 border-primary' style={textStyle}>HÀNH TRÌNH PHÁT TRIỂN CHẤT LƯỢNG VÀ HIỆN ĐẠI</h1>
                    <div className='w-2/3 h-[300px] flex flex-row '>
                        <div className='w-1/3 h-full bg-primary'>

                        </div>
                        <div className='w-2/3 h-full pl-12  tracking-widest '>
                            <h1 className='text-3xl py-8 font-bold text-primary'>1900s</h1>
                            <h2 className='text-2xl font-bold text-primary'>BẮT ĐẦU VÀ PHÁT TRIỂN</h2>
                    ...
                    <div className='w-2/3 h-[350px] mt-20 flex flex-row-reverse '>
                        ...
                        <div className='w-2/3 h-full pr-12 tracking-widest '>
                            <h1 className='text-3xl py-8 font-bold text-primary'>2009</h1>
                            <h2 className='text-2xl font-bold text-primary'>NÂNG CAO CHẤT LƯỢNG VÀ HIỆN ĐẠI HÓA</h2>
                    ...
                    <div className='w-2/3 h-[350px] mt-20 flex flex-row '>
                        ...
                        <div className='w-2/3 h-full pl-12 tracking-widest'>
                            <h1 className='text-3xl py-8 font-bold text-primary'>2019</h1>
                            <h2 className='text-2xl font-bold text-primary'>MỞ RỘNG QUY MÔ</h2>
                    ...
                    <div className='w-2/3 h-[350px] mt-20 flex flex-row-reverse '>
                        ...
                        <div className='w-2/3 h-full pr-12 tracking-widest'>
                            <h1 className='text-3xl py-8 font-bold text-primary'>2020</h1>
                            <h2 className='text-2xl font-bold text-primary'>HIỆN ĐẠI HÓA VÀ XUẤT KHẨU</h2>
            ...
            <div className='w-full h-fit bg-white flex flex-col items-center px-5 pb-24'>
                ...
                <div className='h-fit flex w-4/5 flex-row justify-between gap-10 '>
                    {
                        progresses.map((item) => (
                            <div className='flex flex-col w-[360px] justify-between h-full gap-5'>
                                <img className="w-[360px] h-[360px]" src={item.image} alt="" />

                                <div className='bg-tertiary text-background h-24 py-4 px-4'>
            ...
            <div className='w-full h-fit relative flex overflow-y-hidden'>
                <img className="w-full h-screen" src={WallPaper} alt="" />
                <div className='absolute h-full top-0 left-0 right-0 bottom-0 flex justify-center items-center py-36'>
                    <div className='w-4/5 h-screen flex flex-col items-center flex-wrap gap-10 py-16 justify-center'>
                        <img className="w-[400px] h-auto" src={Image3} alt="" />
                        <img className="w-[400px] h-auto" src={Image2} alt="" />
                        <img className="w-[400px] h-auto" src={Image1} alt="" />
                        <img className="w-[400px] h-auto" src={Image5} alt="" />
                        <img className="w-[400px] h-auto" src={Image4} alt="" />
                    </div>
                </div>
            </div>
